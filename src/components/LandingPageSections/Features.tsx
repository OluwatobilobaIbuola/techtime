    ...
    <section className="px-4 sm:px-28 bg-bgNeutral py-12 sm:py-24 relative">
      <div className="flex sm:flex-row flex-col gap-16">
        ...
        <div className="flex-[40%] flex flex-wrap gap-8 items-center self-center">
          <div className="py-4 px-8 flex-[40%] rounded-[8px] bg-white min-w-[300px]">
            <span
              className={`${styles.flexCenter} w-[48px] h-[48px] rounded-[4px] bg-bgBoxSix`}
            >
          ...
          <div className="py-4 px-8 flex-[40%] rounded-[8px] bg-white min-w-[300px]">
            <span
              className={`${styles.flexCenter} w-[48px] h-[48px] rounded-[4px] bg-bgBoxFive`}
            >
          ...
          <div className="py-4 px-8 flex-[40%] rounded-[8px] bg-white min-w-[300px]">
            <span
              className={`${styles.flexCenter} w-[48px] h-[48px] rounded-[4px] bg-bgBoxSeven`}
            >
          ...
          <div className="py-4 px-8 flex-[40%] rounded-[8px] bg-white min-w-[300px]">
            <span
              className={`${styles.flexCenter} w-[48px] h-[48px] rounded-[4px] bg-bgBoxEight`}
            >
